...
nohup sh parlai display_data -t squad &
nohup sh parlai eval_model -m ir_baseline -t personachat -dt valid &
nohup sh parlai train_model -t personachat -m transformer/ranker -mf \
